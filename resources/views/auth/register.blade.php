            ...
            <form action="{{ route('register') }}" method="POST" class="space-y-5">
                ...
                <div class="flex flex-col space-y-1.5">
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name') }}" required placeholder="Nama lengkap Anda"
                        class="w-full bg-white-bg border border-dark-text/10 text-dark-text focus:border-main-blue/80 focus:ring-1 focus:ring-main-blue/80 rounded-xl px-4 py-3 placeholder:text-grey-text transition-all duration-300 outline-none text-sm font-medium @error('name') border-red-500 @enderror">
                    @error('name')
                ...
                <div class="flex flex-col space-y-1.5">
                    ...
                    <input type="password" id="password" name="password" required placeholder="Minimal 8 karakter"
                        class="w-full bg-white-bg border border-dark-text/10 text-dark-text focus:border-main-blue/80 focus:ring-1 focus:ring-main-blue/80 rounded-xl px-4 py-3 placeholder:text-grey-text transition-all duration-300 outline-none text-sm font-medium @error('password') border-red-500 @enderror">
                    @error('password')
                        <span class="text-xs font-semibold text-red-500 mt-1">{{ $message }}</span>
                    @enderror
                </div>
